...
fun case_2(x: Boolean?) {
    l1@ while (true) {
        l2@ do {
            break@l1
        } while (<!UNREACHABLE_CODE!>true || x as Boolean<!>)
    }
...
fun case_4(x: Boolean?) {
    l1@ do {
        l2@ do {
            break@l1
        } while (<!UNREACHABLE_CODE!>x as Boolean<!>)
    } while (<!UNREACHABLE_CODE!>true<!>)
...
fun case_9(x: Boolean?) {
    l1@ while (true) {
        break@l1
        <!UNREACHABLE_CODE!>l2@ while (x as Boolean) {
...
fun case_10(x: Boolean?) {
    l1@ while (true) {
        l2@ <!UNREACHABLE_CODE!>while (<!>break@l1 <!UNREACHABLE_CODE!>|| x as Boolean) {
...
fun case_12(x: Boolean?) {
    while (true) {
        break <!UNREACHABLE_CODE!>|| x as Boolean<!>
    }
...
fun case_17(x: Boolean?) {
    l1@ while (true) {
        l2@ while (true) {
            l3@ <!UNREACHABLE_CODE!>while (<!>break@l2 <!UNREACHABLE_CODE!>|| x as Boolean) {
...
fun case_18(x: Boolean?) {
    l1@ while (true) {
        l2@ while (true) {
            l3@ <!UNREACHABLE_CODE!>while (<!>break@l1 <!UNREACHABLE_CODE!>|| x as Boolean) {
...
fun case_23(x: Boolean?) {
    l1@ for (i in listOf(1, 2, 3)) {
        l2@ for (j in listOf(1, 2, 3)) {
            break@l1 <!UNREACHABLE_CODE!>|| x as Boolean<!>
        }
    }
...
fun case_25(x: Boolean?) {
    l1@ for (i in listOf(1, 2, 3)) {
        l2@ <!UNREACHABLE_CODE!>for (j in listOf(<!>true || x as Boolean, break@l1 <!UNREACHABLE_CODE!>|| x as Boolean, x as Boolean)) {
            break@l1
        }<!>
    }
...
fun case_26(x: Boolean?) {
    while (true) {
        <!UNREACHABLE_CODE!>for (i in listOf(<!>break, <!UNREACHABLE_CODE!>x as Boolean, x<!UNNECESSARY_NOT_NULL_ASSERTION!>!!<!>)) {
...
fun case_27(x: Int?, y: Class) {
    while (true) {
        y<!UNREACHABLE_CODE!>[<!>break, <!UNREACHABLE_CODE!>x as Int]<!>
    }
...
fun case_28(x: Int?, y: List<List<Int>>) {
    while (true) {
        y[break]<!UNREACHABLE_CODE!>[x as Int]<!>
    }
...
fun case_29(x: Boolean?, y: MutableList<Int>) {
    while (true) {
        y[break] <!UNREACHABLE_CODE!>= 10<!>
        <!UNREACHABLE_CODE!>x!!<!>
    }

    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Boolean & kotlin.Boolean?")!>x<!>
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Boolean & kotlin.Boolean?")!>x<!>.<!DEBUG_INFO_UNRESOLVED_WITH_TARGET, UNRESOLVED_REFERENCE_WRONG_RECEIVER!>not<!>()
}
